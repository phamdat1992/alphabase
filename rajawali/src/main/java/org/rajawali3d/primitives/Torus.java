...
public class Torus extends Object3D {
     ...
     *
     * @param largeRadius The large radius of the torus
     * @param smallRadius The small radius of the torus
     * @param segmentsL   The number of segments on the large radius
     * @param segmentsS   The number of segments on the small radius
     */
     ...
     *
     * @param largeRadius              The large radius of the dount
     * @param smallRadius              The small radius of the dount
     * @param segmentsL                The number of segments on the large radius
     * @param segmentsS                The number of segments on the small radius
